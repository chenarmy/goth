# Goth: Multi-Provider Authentication for Go [![GoDoc](https://godoc.org/github.com/chenarmy/goth?status.svg)](https://godoc.org/github.com/chenarmy/goth) [![Build Status](https://github.com/chenarmy/goth/workflows/ci/badge.svg)](https://github.com/chenarmy/goth/actions) [![Go Report Card](https://goreportcard.com/badge/github.com/chenarmy/goth)](https://goreportcard.com/report/github.com/chenarmy/goth)
...
```text
$ go get github.com/chenarmy/goth
```
...
```text
$ git clone git@github.com:chenarmy/goth.git
```
or use
```text
$ go get github.com/chenarmy/goth
