...
See https://github.com/chenarmy/goth/blob/master/examples/main.go to see this in action.
*/
package gothic
...
See https://github.com/chenarmy/goth/examples/main.go to see this in action.
*/
